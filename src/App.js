...
function App() {
	...
	useEffect(async () => {
		try {
			...
			const respcourse = await axios.get(process.env.REACT_APP_API + "/course");
			console.log(
				"🚀 ~ file: AddCourse.js ~ line 32 ~ useEffect ~ res.data",
				respcourse.data
			);
			if (respcourse.status == 200) {
				// alert('success')
										...
										<div className="main-page">
											<Switch>
												...
												<Route
													path="/overview"
													render={(props) => (
														<Overview key="2" user={user} {...props} />
													)}
												/>
												<Route
													path="/CreateTest"
												...
												<Route
													path="/addsubject"
													render={(props) => (
														<AddSubject key="5" Data={user} {...props} />
													)}
												/>
												<Route
													path="/addCourse"
													render={(props) => (
														<AddCourse key="6" Data={user} {...props} />
													)}
												/>
												<Route
													path="/addChapter"
													render={(props) => (
														<AddChapter key="7" Data={user} {...props} />
													)}
												/>
												<Route
													path="/addTopic"
													render={(props) => (
														<AddTopic key="8" Data={user} {...props} />
													)}
												/>
												...
												<Route
													path="/settings"
													render={(props) => <Settings key="9" {...props} />}
												/>
												<Route
													path="/AddQuestion"
													render={(props) => (
												...
												<Route
													path="/AddVideo"
													render={(props) => <AddVideos key="11" {...props} />}
												/>
												<Route
													path="/addNewUser"
													render={(props) => <AddUsers key="12" {...props} />}
												/>
												<Route
													path="/AddBlog"
													render={(props) => <AddBlog key="13" {...props} />}
												/>
												<Route
